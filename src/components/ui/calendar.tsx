  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_range_start: "aria-selected:bg-primary bg-primary text-primary-foreground",
        day_range_end: "aria-selected:bg-primary bg-primary text-primary-foreground",
        day_range_middle: "aria-selected:bg-accent bg-accent text-muted-foreground",
